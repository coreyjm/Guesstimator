...
function populateQuestions(){
	...
	for (var i = 1; i <= 10; i++) {
    html.push("<div class='row question-row' data-question='question-" + i + "'><div class='col-sm-12 quest'>" + questionsAnswers['question-' + i]['question'] + "</div><div class='col-sm-6 lowest'><input class='form-control' type='text' name='low' value ='low estimate'></div><div class='col-sm-6 highest'><input class='form-control' type='text' name='high' value='High estimate'></div><div class='final col-sm-12'></div></div>");
	}
